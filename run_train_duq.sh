...
#SBATCH --output=/scratch/yli44/logs/anomaly-%j.out  # Output file
#SBATCH --error=/scratch/yli44/logs/anomaly-%j.err   # Error file
...
#python train_cityscapes_duq.py
python train_duq_cityscapes.py
